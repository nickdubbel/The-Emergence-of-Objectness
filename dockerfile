...
# install the Emergence of Objectness
WORKDIR /workspace
RUN git clone https://github.com/rt219/The-Emergence-of-Objectness.git
WORKDIR /workspace/The-Emergence-of-Objectness
# replace the requirements.txt with the one in the same folder as this file
